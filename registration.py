...
import sqlite3 #Interacts with SQLite database
from PIL import Image, ImageTk
import re #Regular expressions for email validation
import random #Generates random number (used for uniqueness).
import os
import cv2
...
#These variables will store input values from the form fields.
...
image2 = image2.resize((600, 800), Image.Resampling.LANCZOS)
